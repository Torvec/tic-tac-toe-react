...
const classNames = {
  large:
    "cursor-pointer bg-neutral-700 text-neutral-300 rounded-xl uppercase text-3xl font-bold aspect-square md:size-64 lg:size-96 hover:bg-neutral-400 hover:text-neutral-700 hover:transition-colors hover:duration-300 hover:ease-in-out",
  small:
