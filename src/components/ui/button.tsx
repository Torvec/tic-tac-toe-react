...
const classNames = {
  large:
    "cursor-pointer bg-neutral-700 text-neutral-300 md:rounded-xl uppercase text-3xl font-bold aspect-square size-full hover:bg-neutral-400 hover:text-neutral-700 hover:transition-colors hover:duration-300 hover:ease-in-out",
  small:
